        ...
        if(opModeIsActive()) {
            ...
            if (zone == 1) {
                backBoard = drive.trajectoryBuilder(zone1.end())
                        .lineTo(new Vector2d(-36,54 - 6 * zone))
            ...
            //Note: To deliver first pixel, spin intake in reverse
